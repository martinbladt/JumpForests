...
veteran_tree <- jftree(Surv(time, status) ~ ., veteran, seed = 2025, min_node_size = 10, honest = TRUE, max_depth = 3)
...
veteran_forest <- jfforest(Surv(time, status) ~ ., data = veteran, nsplits = 10, ntrees = 500, seed = 2025, honest = FALSE, swr = TRUE, save_predictions = FALSE, double_bootstrap = FALSE)
