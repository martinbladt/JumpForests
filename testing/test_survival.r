...
veteran_forest <- jfforest(Surv(time, status) ~ ., data = veteran, nsplits = 10, ntrees = 500, seed = 2025, honest = TRUE, swr = TRUE, save_predictions = TRUE, double_bootstrap = FALSE)
